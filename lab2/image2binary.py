...
palleteFile = "resources/colors.png" #pallete the BIOS uses
convertFile = "resources/pika3.gif" #image to turn into a binary
outputFile  = "bin/image3.bin" #name of output file
